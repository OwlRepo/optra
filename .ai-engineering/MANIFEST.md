...
This is the authoritative package inventory.

Rules:

- Each responsibility has exactly one canonical file.
- Do not create alternate filenames for an existing responsibility.
- During setup, copy and adapt this inventory into `.ai-engineering/`.
- During validation, undeclared duplicate rule or workflow files fail the check.
