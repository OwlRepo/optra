...
description: "Use proactively to audit workspace isolation (workspaceId + membership guards), JWT/OTP auth, rate limits and token budgets, S3 object paths, SSRF, uploads and secrets. Read-only validator."
