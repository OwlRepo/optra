---
name: test-engineer
description: "Use proactively for the RED round before implementers run and for the post-implementation test review. Writes Jest specs in apps/api, Vitest specs elsewhere and Playwright specs in apps/e2e, error: > edge: > regression: > happy:, and records RED with bun run tdd:red."
